...
class CalculatorNetto extends StatefulWidget {
  @override
  _CalculatorNettoState createState() => _CalculatorNettoState();
}

class _CalculatorNettoState extends State<CalculatorNetto> {
  double grandTotal = 0;
  ...
  void updateSubtotal() {
    setState(() {
      for (int i = 0; i < maxRows; i++) {
        subTotal[i] = quantity[i] * hargaBarang[i];
      }
